...
/* From hfclk */
struct __metal_driver_fixed_clock __metal_dt_hfclk = {
    .clock.vtable = &__metal_driver_vtable_fixed_clock.clock,
};

/* From rtcclk */
struct __metal_driver_fixed_clock __metal_dt_rtcclk = {
    .clock.vtable = &__metal_driver_vtable_fixed_clock.clock,
};

/* From pclk */
struct __metal_driver_fixed_clock __metal_dt_pclk = {
    .clock.vtable = &__metal_driver_vtable_fixed_clock.clock,
};
...
struct __metal_driver_fixed_clock __metal_dt_system_multipbus_clock = {
    .clock.vtable = &__metal_driver_vtable_fixed_clock.clock,
};
...
/* From i2c@10031000 */
struct __metal_driver_sifive_i2c0 __metal_dt_i2c_10031000 = {
    .i2c.vtable = &__metal_driver_vtable_sifive_i2c0.i2c,
};
