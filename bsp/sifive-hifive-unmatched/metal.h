...
#endif
#define __METAL_PLIC_SUBINTERRUPTS 70
...
#define METAL_SIFIVE_CCACHE0_INTERRUPTS { 1, 2, 3, 4, }
...
#define __METAL_I2C_10030000_INTERRUPTS 1

#define __METAL_I2C_10031000_INTERRUPTS 1
...
/* From hfclk */
extern struct __metal_driver_fixed_clock __metal_dt_hfclk;

/* From rtcclk */
extern struct __metal_driver_fixed_clock __metal_dt_rtcclk;

/* From pclk */
extern struct __metal_driver_fixed_clock __metal_dt_pclk;
...
extern struct __metal_driver_fixed_clock __metal_dt_system_multipbus_clock;
...
/* From i2c@10031000 */
extern struct __metal_driver_sifive_i2c0 __metal_dt_i2c_10031000;

/* From prci@10000000 */
extern struct __metal_driver_sifive_prci0 __metal_dt_prci_10000000;
...
{
	if ((uintptr_t)clock == (uintptr_t)&__metal_dt_hfclk) {
		return METAL_FIXED_CLOCK__HFCLK_CLOCK_FREQUENCY;
	}
	else if ((uintptr_t)clock == (uintptr_t)&__metal_dt_rtcclk) {
		return METAL_FIXED_CLOCK__RTCCLK_CLOCK_FREQUENCY;
	}
	else if ((uintptr_t)clock == (uintptr_t)&__metal_dt_pclk) {
		return METAL_FIXED_CLOCK__PCLK_CLOCK_FREQUENCY;
	}
	...
	else if ((uintptr_t)clock == (uintptr_t)&__metal_dt_system_multipbus_clock) {
		return METAL_FIXED_CLOCK__SYSTEM_MULTIPBUS_CLOCK_CLOCK_FREQUENCY;
	}
	else {
		return 0;
	}
...
static __inline__ unsigned long __metal_driver_sifive_i2c0_control_base(struct metal_i2c *i2c)
{
	...
	else if ((uintptr_t)i2c == (uintptr_t)&__metal_dt_i2c_10031000) {
		return METAL_SIFIVE_I2C0_10031000_BASE_ADDRESS;
	}
	else {
		return 0;
	}
...
static __inline__ unsigned long __metal_driver_sifive_i2c0_control_size(struct metal_i2c *i2c)
{
	if ((uintptr_t)i2c == (uintptr_t)&__metal_dt_i2c_10030000) {
		...
		return METAL_SIFIVE_I2C0_10031000_SIZE;
	}
	else {
		return 0;
	}
...
{
	if ((uintptr_t)i2c == (uintptr_t)&__metal_dt_i2c_10030000) {
		return (struct metal_clock *)&__metal_dt_pclk.clock;
	}
	else if ((uintptr_t)i2c == (uintptr_t)&__metal_dt_i2c_10031000) {
		return (struct metal_clock *)&__metal_dt_pclk.clock;
	}
...
/* --------------------- sifive_prci0 ------------ */
static __inline__ unsigned long __metal_driver_sifive_prci0_control_base(struct metal_prci *prci)
{
	if ((uintptr_t)prci == (uintptr_t)&__metal_dt_prci_10000000) {
		return METAL_SIFIVE_FU740_C000_PRCI0_10000000_BASE_ADDRESS;
	}
	else {
		return 0;
	}
...
static __inline__ unsigned long __metal_driver_sifive_prci0_control_size(struct metal_prci *prci)
{
	if ((uintptr_t)prci == (uintptr_t)&__metal_dt_prci_10000000) {
		return METAL_SIFIVE_FU740_C000_PRCI0_10000000_SIZE;
	}
	else {
		return 0;
	}
...
struct __metal_driver_sifive_gpio_switch *__metal_switch_table[] __attribute__((weak))  = {
					NULL };
#define __METAL_DT_MAX_I2CS 2

struct __metal_driver_sifive_i2c0 *__metal_i2c_table[] __attribute__((weak))  = {
					&__metal_dt_i2c_10030000,
					&__metal_dt_i2c_10031000};

/* From prci@10000000 */
#define __METAL_DT_SIFIVE_PRCI0_HANDLE (&__metal_dt_prci_10000000)

#define __METAL_DT_PRCI_10000000_HANDLE (&__metal_dt_prci_10000000)
