...
#ifndef SPIKE____METAL_INLINE_H
#define SPIKE____METAL_INLINE_H
...
/* From htif */
struct __metal_driver_sifive_htif0_shutdown __metal_dt_htif_shutdown = {
    .vtable = &__metal_driver_vtable_sifive_htif0_shutdown,
    .shutdown.vtable = &__metal_driver_vtable_sifive_htif0_shutdown.shutdown,
};

/* From htif */
struct __metal_driver_sifive_htif0_uart __metal_dt_htif_uart = {
    .vtable = &__metal_driver_vtable_sifive_htif0_uart,
    .uart.vtable = &__metal_driver_vtable_sifive_htif0_uart.uart,
};


#endif /* SPIKE____METAL_INLINE_H*/
#endif /* ! ASSEMBLY */
