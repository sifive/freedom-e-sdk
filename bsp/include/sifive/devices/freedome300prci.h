...
#ifndef _SIFIVE_FREEDOME300PRCI_H
#define _SIFIVE_FREEDOME300PRCI_H

/* Register offsets */

#define FREEDOME300PRCI_HFROSCCFG   (0x0000)
#define FREEDOME300PRCI_HFXOSCCFG   (0x0004)
#define FREEDOME300PRCI_PLLCFG      (0x0008)
#define FREEDOME300PRCI_PLLDIV      (0x000C)
#define FREEDOME300PRCI_PROCMONCFG  (0x00F0)
...
#endif // _SIFIVE_FREEDOME300PRCI_H
